export const CHART_TYPES = [
    // --- BÁSICOS (Highcharts Core) ---
    { value: 'line', label: 'Línea' },
    { value: 'spline', label: 'Línea Suavizada' },
    ...
    { value: 'columnrange', label: 'Rango de Columnas' },
    { value: 'bubble', label: 'Burbujas' },
    { value: 'gauge', label: 'Medidor / Velocímetro' },
    { value: 'boxplot', label: 'Cajas y Bigotes' },
