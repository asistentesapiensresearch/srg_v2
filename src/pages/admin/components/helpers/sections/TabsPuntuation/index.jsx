...
const TabsPuntuation = ({ sourceConfig, filterField, filterValue, textcolor = "#1f2937"}) => {
        ...
        {scoreColumns.map(({ key, label }) => (
          ...
          >
            ...
            <div className="mt-4 flex flex-col items-center gap-2">
              <div className="relative flex flex-col items-center justify-center w-28 h-28 rounded-full bg-linear-to-br from-sky-50 to-sky-100 shadow-inner">
                ...
                <div className="flex h-full w-full items-center justify-center">
                  <span className="text-4xl font-extrabold text-sky-900 drop-shadow-sm">
                    {record[key] ?? '-'}
                  </span>
                </div>
              </div>
  ...
  return (
    <div>
        <div className='border-l-2 border-[#C10007] mb-4'>
      <h3 className='ml-2 font-[Roboto] font-black text-xl text-[#C10007]'>Tablas de puntuación</h3>
        </div>
      {renderContent()}
    </div>
  );
