...
function Item({ option, onDelete, ...other }) {
    return (
...
// ---------- MAIN COMPONENT ----------
function BrandComponentFN(props) {
    const {
        getRootProps,
        getInputLabelProps,
        getInputProps,
    ...
    return (
        <Root>
            <div {...getRootProps()}>
                <Label {...getInputLabelProps()}>Marcas</Label>
...
// ---------- EXPORT ----------
export default function BrandsListInput({
    value,
    onChange
}) {
    const { brands } = useBrand();
    const [selectedBrands, setSelectedBrands] = useState(value || []);
