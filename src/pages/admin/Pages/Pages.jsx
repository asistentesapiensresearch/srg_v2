...
export default function Pages() {
    const { pages, loading, handleSave, handleDelete } = usePage();
    ...
    if (loading && pages.length === 0) return <Preloader />;
            ...
            >
                <Box>
                    ...
                    <Typography color="text.secondary" variant="body1">
                        Gestiona el contenido editorial, noticias y el diseño de las páginas.
                    </Typography>
                </Box>
