...
export default function AlliesPage() {
  ...
  return (
    <div className="p-8">
      <h1 className="text-3xl font-bold mb-4">Panel de Aliados</h1>
      <p className="text-gray-600 mb-2">Bienvenido al panel de aliados.</p>
      <p className="mb-6">Tu grupo actual: <strong className="text-blue-600">{userGroups.join(', ') || 'Ninguno'}</strong></p>
      
      <div className="mt-8">
        <h2 className="text-2xl font-semibold mb-4">Funciones de Aliado</h2>
        <ul className="list-disc list-inside space-y-2 text-gray-700">
          <li>Gestión de contenido colaborativo</li>
          <li>Acceso a recursos compartidos</li>
